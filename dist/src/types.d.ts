...
export declare const PLUGIN_ID = "openclaw-codex-app-server";
export declare const INTERACTIVE_NAMESPACE = "codexapp";
export declare const STORE_VERSION = 2;
export declare const CALLBACK_TOKEN_BYTES = 9;
export declare const CALLBACK_TTL_MS: number;
export declare const PENDING_INPUT_TTL_MS: number;
...
export type PendingApprovalDecision = "accept" | "acceptForSession" | "decline" | "cancel";
